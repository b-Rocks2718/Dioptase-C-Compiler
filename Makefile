...
$(TAC_INTERP_TEST_OBJ_DEBUG): $(TAC_INTERP_TEST_SRC) $(SRC_DIR)/TAC.h | dirs-debug
	$(CC) $(CFLAGS_DEBUG) -I$(SRC_DIR) -c $< -o $@

$(TAC_INTERP_TEST_OBJ_RELEASE): $(TAC_INTERP_TEST_SRC) $(SRC_DIR)/TAC.h | dirs-release
...
$(TAC_EXEC_TEST_OBJ_DEBUG): $(TAC_EXEC_TEST_SRC) $(SRC_DIR)/TAC.h | dirs-debug
	$(CC) $(CFLAGS_DEBUG) -I$(SRC_DIR) -c $< -o $@

$(TAC_EXEC_TEST_OBJ_RELEASE): $(TAC_EXEC_TEST_SRC) $(SRC_DIR)/TAC.h | dirs-release
	$(CC) $(CFLAGS_RELEASE) -I$(SRC_DIR) -c $< -o $@
