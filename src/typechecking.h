...
// Stored in IdentAttr for later codegen.
struct IdentInit {
...
// Print the contents of the symbol table to stdout.
...
// Print the contents of the type table to stdout.
...
// Print identifier attributes in a readable format.
void print_ident_attr(struct IdentAttr* attrs);

// Print identifier initializer metadata in a readable format.
